...
export const translations = {
  en: {
    ...
    excelMode: "Excel / CSV Mode (Batch printing)",
    ...
    printTopMargin: "Top Print Margin (mm)",
  },
  jp: {
    appTitle: "Thermal Printer Web UI",
    tabLabel: "ラベル",
    ...
    excelMode: "Excel / CSVモード (一括印刷)",
    excelFile: "表計算ファイル (Excel/CSV)",
    excelDelay: "印刷ディレイ (秒)",
